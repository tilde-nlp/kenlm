...
int main(int argc, char *argv[]) {
  try {
    ...
    options.add_options()
      ...
      ("counts_only", po::bool_switch(&pipeline.counts_only), "Count ngrams, don't calculate probabilities")
      ("counts_arpa", po::value<std::vector<std::string> >(&pipeline.counts_arpa)->multitoken(), "Load ngram counts from ARPA file")
